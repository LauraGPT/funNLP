...
|    FunASR / SenseVoice    |  阿里达摩院开源语音识别工具包，支持中文/多语种ASR、VAD、标点、说话人识别、热词与流式/离线推理；SenseVoice适合轻量多语种语音理解。       |   [FunASR](https://github.com/modelscope/FunASR)<br>[SenseVoice](https://github.com/FunAudioLLM/SenseVoice)  |
